...
public class Login extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Query q=s.createQuery("Select c from Client c where c.compteByLogin.login=:email and c.compteByLogin.mdp=:mdp");
        ...
        if(l.size()>0){
            ...
            request.setAttribute("msg", "login ou mot de passe errone!");
